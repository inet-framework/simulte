...
#ifndef LTEHARQPROCESSRX_H_
#define LTEHARQPROCESSRX_H_
...
class LteHarqProcessRx {
    ...
    public:
        ...
        */
         ...
         */
        virtual RxHarqPduStatus getUnitStatus(Codeword cw) {return status_.at(cw);}
        ...
        */
         ...
         */
        virtual unsigned int getNumHarqUnits() { return MAX_CODEWORDS; }
