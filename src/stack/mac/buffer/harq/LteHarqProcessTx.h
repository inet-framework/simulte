...
#ifndef LTEHARQPROCESSTX_H_
#define LTEHARQPROCESSTX_H_
...
class LteHarqProcessTx {
    ...
    public:
         ...
         * @return
         */
        LteHarqProcessTx(unsigned char acid, unsigned int numUnits, unsigned int numProcesses, LteMacBase *macOwner, LteMacBase *dstMac);
        ...
        unsigned int getNumHarqUnits() { return numHarqUnits_; }
