...
class LteSchedulerEnb {
    ...
    public:
        ...
        */
         ...
         */
        unsigned int& resourceBlocks() {return resourceBlocks_;}

        /**
         * Gets the amount of the system resource block
         */
        unsigned int getResourceBlocks() {return resourceBlocks_;}
         ...
         */
        virtual unsigned int schedulePerAcidRtx(MacNodeId nodeId, Codeword cw, unsigned char acid, std::vector<BandLimit>* bandLim = NULL, Remote antenna = MACRO,bool limibBl=false) = 0;
