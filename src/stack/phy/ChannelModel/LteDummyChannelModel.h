...
public:
     ...
     */
    virtual double getAttenuation(MacNodeId nodeId,Direction dir,Coord coord){return 0;};
    /*
    ...
    //TODO
    virtual bool errorDas(LteAirFrame *frame,UserControlInfo* lteI){opp_error("DAS PHY LAYER TO BE IMPLEMENTED"); return false;};
};
